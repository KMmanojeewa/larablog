...
/* harmony import */ var _main_component_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./main-component.js */ "./resources/js/main-component.js");


console.log('....appjs....');
(0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)(_main_component_js__WEBPACK_IMPORTED_MODULE_1__["default"]).mount('#vueapp');

/***/ }),

/***/ "./resources/js/main-component.js":
/*!****************************************!*\
  !*** ./resources/js/main-component.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  methods: {
    loadUsers: function loadUsers() {
      ...
      axios.get('./api/customers').then(function (response) {
        _this.customers = response.data.customers; // console.log(response)
      });
    }
  },
